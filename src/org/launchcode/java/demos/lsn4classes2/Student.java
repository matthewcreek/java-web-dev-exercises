...
public class Student {
    ...
    public String getGradeLevel() {
        ...
        } else if (this.numberOfCredits < 30 && this.numberOfCredits >= 0) {
            return (this.name + " is a Freshman.");
        } else return (this.name + " has an invalid number of credits.");
    }
    ...
    public void addGrade(int courseCredits, double grade) {
        ...
        double newQualityScore = (courseCredits * grade) + currentQualityScore;
